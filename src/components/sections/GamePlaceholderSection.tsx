...
export function GamePlaceholderSection() {
  return (
        ...
        >
          <Card className="bg-bg-base border-2 border-dashed border-[#e0d9d0] shadow-sm hover:shadow-md transition-shadow h-96 flex items-center justify-center">
            <CardContent className="flex flex-col items-center justify-center text-center p-8">
              <Gamepad2 className="w-24 h-24 text-gray-300 mb-6" strokeWidth={1.5} />
              <Badge variant="gold" className="mb-4 text-sm px-4 py-1">Coming Soon</Badge>
              <h3 className="text-2xl font-serif font-bold mb-3">Phần này đang được phát triển...</h3>
              <p className="text-text-muted text-lg">Trải nghiệm một ngày làm tài xế công nghệ — sắp ra mắt</p>
            </CardContent>
          </Card>
        </motion.div>
      </div>
